...
private final class XMLFeedParser: NSObject, XMLParserDelegate {
    ...
    func parser(
        ...
        if inItem {
            ...
            case "pubdate", "published", "updated", "dc:date": pubDate = value
            case "guid", "id": guid = value
            case "category": if !value.isEmpty { categories.append(value) }
            case "source": if !value.isEmpty { categories.append(value) }
            default: break
            }
        }
