...
enum ThreatActor: String, CaseIterable, Identifiable, Codable, Hashable {
    ...
    var shortLabel: String {
        ...
        case .northKorea: return "NK"
        case .adversarialAI: return "AI"
        case .digitalSovereignty: return "SOV"
...
enum FeedSource: String, CaseIterable, Identifiable, Codable, Hashable {
    ...
    var feedURL: URL {
        switch self {
        case .theRecord:
            return URL(string: "https://therecord.media/feed")!
        case .lawfare:
            return URL(string: "https://www.lawfaremedia.org/feed")!
        case .krebs:
            return URL(string: "https://krebsonsecurity.com/feed/")!
        case .googleLawfare:
            return URL(string: "https://news.google.com/rss/search?q=site:lawfaremedia.org+(cyber+OR+russia+OR+china+OR+%22north+korea%22+OR+AI+OR+sovereignty)&hl=en-US&gl=US&ceid=US:en")!
        case .googleStateCyber:
            return URL(string: "https://news.google.com/rss/search?q=(Russia+OR+China+OR+%22North+Korea%22)+(cyber+OR+APT+OR+espionage)+OR+%22digital+sovereignty%22+OR+%22adversarial+AI%22&hl=en-US&gl=US&ceid=US:en")!
        }
    }

    var brandMark: String {
        switch self {
        case .theRecord: return "TR"
        case .lawfare, .googleLawfare: return "LF"
        case .krebs: return "KS"
        case .googleStateCyber: return "GN"
        }
    }
}
