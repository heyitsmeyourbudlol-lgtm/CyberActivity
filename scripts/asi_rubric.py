...
# Needle: LOG_TAIL_SEEK_2026_09_05 — improve-loop.log ~46MB on hub; path.read_text()
# then [-tail] paid ~325ms on every factory first-MISS / ASI log probe. Seek
# last N bytes (~0.1ms) preserves needle semantics without full-file decode.
# Re-land hub 2026-09-08 (Mac sync / clobber dropped seek; peer-1 still had it).
